...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("ᴜɴᴄʟᴇ ᴍᴜᴛʜᴜ ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("ᴜɴᴄʟᴇ ᴍᴜᴛʜᴜ ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("ᴜɴᴄʟᴇ ᴍᴜᴛʜᴜ ⏹ Stopped.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("ᴜɴᴄʟᴇ ᴍᴜᴛʜᴜ ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("ᴜɴᴄʟᴇ ᴍᴜᴛʜᴜ ❇️ Admin cache refreshed!")
